...
import com.temporal.api.core.event.data.recipe.holder.SwordShapedRecipeHolder;
...
@DefinedRecipe
@Injected(false)
public class DragonSwordRecipe implements SwordShapedRecipeHolder {
    @Override
    ...
    public ItemLike getResult() {
        return DragonItems.DRAGON_SWORD;
    }
}
