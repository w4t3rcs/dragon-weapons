...
public final class DragonArmorMaterials {
    private static final ArmorMaterialFactory ARMOR_MATERIAL_FACTORY =  new ArmorMaterialFactory();
    @ArmorAsset
    ...
    }), 16, 4, 4F, 0.5F, DragonItemTags.REPAIRS_DRAGON_ARMOR, SoundEvents.ARMOR_EQUIP_GENERIC);
}
